...
represents all the numbers from 1 through 10. A range with two dots goes up to and includes the second number. A range with three dots excludes the second number. For example, (0...10) goes from 0 to 9, and does not include 10. We can iterate over
